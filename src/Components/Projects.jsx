...
const Projects = () => (
  <div className="text-center mt-24 lg:mt-12 md:pt-20 my-10">
    ...
    <div className="mb-20 mt-12 flex flex-wrap flex-col justify-center items-center md:hidden">
      {data.map((item) => (
        <div className="p-4">
        <div className="w-72 h-auto md:w-80 md:h-auto lg:w-96 lg:h-96 m-6 rounded bg-green-900 backdrop-saturate-200" style={{ backgroundImage: `url(${item.img}) ` }} key={item.id}>
    ...
    <div className="mb-20 mt-12 hidden md:flex flex-col justify-center items-center">
      {data.map((item) => (
        <div className="p-4">
        <div className="w-72 h-auto md:w-80 md:h-auto lg:w-96 lg:h-96 m-6 rounded bg-green-900 backdrop-saturate-200" style={{ backgroundImage: `url(${item.img}) ` }} key={item.id}>
          <div className= "p-4 backdrop-saturate-200 bg-black/70">
